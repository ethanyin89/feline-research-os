...
SAMPLES = [
    ...
    },
    {
        ...
        "expected_disease": "ckd",
        "expected_mode": "local_explanation",
        "expected_surface": "ckd_researcher_overview",
        "min_sources": 4,
        "quality_groups": [
            ["feline CKD", "feline chronic kidney disease"],
    ...
    },
    {
        ...
        "expected_disease": "ckd",
        "expected_mode": "local_explanation",
        "expected_surface": "ckd_treatment_boundary",
        "min_sources": 4,
        "quality_groups": [["治疗边界"], ["renal diet"], ["phosphorus"], ["不能说过头"], ["不是兽医诊疗建议"], ["下一步"]],
    },
    {
        "question": "猫糖尿病怎么治疗",
        "expected_disease": "diabetes",
        "expected_mode": "local_explanation",
        "expected_surface": "diabetes_treatment_boundary",
        "min_sources": 4,
        "quality_groups": [["治疗边界"], ["branch separation"], ["SGLT2"], ["ketone monitoring"], ["不能说过头"], ["不是兽医诊疗建议"], ["下一步"]],
    },
    {
        "question": "猫FIP怎么治疗",
        "expected_disease": "fip",
        "expected_mode": "local_explanation",
        "expected_surface": "fip_treatment_boundary",
        "min_sources": 4,
        "quality_groups": [["治疗边界"], ["GS-441524"], ["remdesivir"], ["neurologic rescue"], ["不能说过头"], ["不是兽医诊疗建议"], ["下一步"]],
    },
    {
        "question": "猫HCM怎么治疗",
        "expected_disease": "hcm",
        "expected_mode": "local_explanation",
        "expected_surface": "hcm_treatment_boundary",
        "min_sources": 4,
        "quality_groups": [["治疗边界"], ["structural phenotype"], ["intervention hierarchy"], ["不能说过头"], ["不是兽医诊疗建议"], ["下一步"]],
    },
    {
        "question": "猫肥胖怎么治疗",
        "expected_disease": "obesity",
        "expected_mode": "local_explanation",
        "expected_surface": "obesity_treatment_boundary",
        "min_sources": 4,
        "quality_groups": [["治疗边界"], ["compiled starter"], ["prevention"], ["weight-loss protocol"], ["不能说过头"], ["不是兽医诊疗建议"], ["下一步"]],
    },
    {
        "question": "猫肿瘤怎么治疗",
        "expected_disease": "cancer",
        "expected_mode": "local_explanation",
        "expected_surface": "cancer_treatment_boundary",
        "min_sources": 4,
        "quality_groups": [["治疗边界"], ["architecture-level"], ["clinical workflow"], ["rank treatments"], ["不能说过头"], ["不是兽医诊疗建议"], ["下一步"]],
    },
    {
        "question": "猫IBD怎么治疗",
        "expected_disease": "ibd",
        "expected_mode": "local_explanation",
        "expected_surface": "ibd_treatment_boundary",
        "min_sources": 4,
        "quality_groups": [["治疗边界"], ["chronic enteropathy"], ["diet response"], ["lymphoma boundary"], ["不能说过头"], ["不是兽医诊疗建议"], ["下一步"]],
    },
    {
        "question": "猫杯状病毒怎么治疗",
        "expected_disease": "fcv",
        "expected_mode": "local_explanation",
        "expected_surface": "fcv_treatment_boundary",
        "min_sources": 4,
        "quality_groups": [["治疗边界"], ["therapy"], ["vaccine"], ["treatment guidance"], ["不能说过头"], ["不是兽医诊疗建议"], ["下一步"]],
    },
]
