---
id: system-health-report-20260613
type: health-check
...
| Check | Status | Read |
|---|---|---|
| Markdown links | PASS | PASS: checked 2562 markdown files, no local link issues found. |
...
| Compile trigger | PASS | 828 changed source cards, 91 downstream files |
...
|---|---:|---|---|
| ckd | 197 | abstract_full: 2, full: 28, partial: 167 | abstract_weighted: 54, deep_extracted: 28, source_checked: 2, title_only: 113 |
| fip | 242 | full: 26, partial: 216 | abstract_weighted: 23, deep_extracted: 26, title_only: 193 |
...
| cancer | 111 | abstract: 29, deep: 43, full: 29, partial: 10 | abstract_weighted: 74, deep_extracted: 29, publisher_verified: 1, source_checked: 2, title_only: 5 |
