---
id: system-health-report-20260626
type: health-check
...
# Vault Health Report, 2026-06-26
...
| Check | Status | Read |
|---|---|---|
| Markdown links | PASS | PASS: checked 2672 markdown files, no local link issues found. |
...
| Low-word paper cards | FAIL | 15 cards below 700 words |
...
| Compile trigger | PASS | 22 changed source cards, 145 downstream files |
| API keys | PASS | present: OPENROUTER_API_KEY, OPENAI_API_KEY |
| V2 field quality | PASS | 342 V2 cards: A=95, B=247, C=0, F=0 |
...
| obesity | 95 | abstract_full: 1, full: 7, partial: 87 | abstract_weighted: 81, deep_extracted: 6, source_checked: 1, title_only: 7 |
...
Total cards with V2 fields: 342
Grade distribution: A=95, B=247, C=0, F=0
