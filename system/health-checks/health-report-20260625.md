---
id: system-health-report-20260625
type: health-check
...
# Vault Health Report, 2026-06-25
...
| Check | Status | Read |
|---|---|---|
| Markdown links | PASS | PASS: checked 2666 markdown files, no local link issues found. |
...
| Compile trigger | PASS | 16 changed source cards, 107 downstream files |
...
| diabetes | 121 | full: 40, partial: 81 | abstract_weighted: 74, deep_extracted: 39, title_only: 8 |
