---
id: system-health-report-20260621
type: health-check
topic: operating-system
question_type: health
language: bilingual
last_compiled_at: 2026-06-21
...
# Vault Health Report, 2026-06-21
...
| Check | Status | Read |
|---|---|---|
| Markdown links | PASS | SKIPPED |
| Query tests | PASS | SKIPPED |
...
| Low-word paper cards | FAIL | 14 cards below 700 words |
...
| Compile trigger | PASS | 338 changed source cards, 763 downstream files |
| API keys | PASS | present: OPENROUTER_API_KEY, OPENAI_API_KEY |
| V2 field quality | WARN | 340 V2 cards: A=86, B=202, C=49, F=3 |

## Source Card Reality

| Disease | Cards | extraction_depth | verification_status |
|---|---:|---|---|
| ckd | 197 | full: 37, partial: 160 | abstract_weighted: 51, deep_extracted: 37, title_only: 109 |
| fip | 242 | full: 32, partial: 210 | abstract_weighted: 20, deep_extracted: 32, title_only: 190 |
| hcm | 226 | full: 31, partial: 195 | abstract_weighted: 1, deep_extracted: 31, title_only: 194 |
| ibd | 126 | full: 25, partial: 101 | deep_extracted: 25, title_only: 101 |
| diabetes | 121 | full: 28, partial: 93 | abstract_weighted: 86, deep_extracted: 27, title_only: 8 |
| fcv | 296 | full: 26, partial: 270 | abstract_weighted: 77, deep_extracted: 26, title_only: 193 |
| obesity | 95 | abstract_full: 1, full: 5, partial: 89 | abstract_weighted: 83, deep_extracted: 4, source_checked: 1, title_only: 7 |
| cancer | 111 | abstract: 28, deep: 32, full: 41, partial: 10 | abstract_weighted: 62, deep_extracted: 41, publisher_verified: 1, source_checked: 2, title_only: 5 |
...
Grade distribution: A=86, B=202, C=49, F=3
...
| hcm | 32 | 18 | 14 | 0 | 0 |
| ibd | 26 | 3 | 17 | 6 | 0 |
| diabetes | 26 | 3 | 20 | 3 | 0 |
| fcv | 58 | 6 | 39 | 13 | 0 |
| obesity | 16 | 1 | 8 | 7 | 0 |
| cancer | 111 | 26 | 71 | 11 | 3 |

### V2 Quality Issues (52 cards)

- [C] src-fip-001: title_gap: empty or too short (<10 chars)
- [C] src-fip-002: title_gap: empty or too short (<10 chars)
- [C] src-fip-003: title_gap: empty or too short (<10 chars)
- [C] src-fip-007: title_gap: empty or too short (<10 chars)
- [C] src-fip-008: title_gap: empty or too short (<10 chars); evidence_boundary: vague limitation
- [C] src-fip-009: title_gap: empty or too short (<10 chars)
- [C] src-fip-010: title_gap: empty or too short (<10 chars); evidence_boundary: vague limitation
- [C] src-fip-011: title_gap: empty or too short (<10 chars)
- [C] src-fip-012: title_gap: empty or too short (<10 chars)
- [C] src-ibd-003: core_argument: no clear stance or claim; evidence_boundary: vague limitation
- [C] src-ibd-005: evidence_boundary: vague limitation
- [C] src-ibd-008: core_argument: no clear stance or claim; evidence_boundary: vague limitation
- [C] src-ibd-021: core_argument: no clear stance or claim; evidence_boundary: vague limitation
- [C] src-ibd-023: core_argument: no clear stance or claim; evidence_boundary: vague limitation
- [C] src-ibd-024: core_argument: topic description, not a claim; evidence_boundary: vague limitation
- [C] src-diabetes-006: quoted_fact contains interpretation: 'Dietary management should be considered alongside ...'; core_argument: no clear stance or claim
- [C] src-diabetes-008: core_argument: no clear stance or claim; evidence_boundary: vague limitation
- [C] src-diabetes-018: core_argument: no clear stance or claim; evidence_boundary: vague limitation
- [C] src-fcv-009: quoted_fact contains interpretation: 'MDPI abstract reports all cats should be vaccinate...'; evidence_boundary: vague limitation
- [C] src-fcv-022: core_argument: no clear stance or claim; evidence_boundary: vague limitation
- ... 32 more
...
- topics/ckd/index-bilingual.md: src-ckd-053 (abstract_weighted), src-ckd-054 (abstract_weighted)
- topics/ckd/index.md: src-ckd-053 (abstract_weighted), src-ckd-054 (abstract_weighted)
- topics/ckd/mechanism-overview.md: src-ckd-053 (abstract_weighted), src-ckd-054 (abstract_weighted), src-ckd-058 (abstract_weighted), src-ckd-061 (abstract_weighted), src-ckd-087 (title_only), src-ckd-098 (title_only), src-ckd-101 (title_only), src-ckd-121 (title_only), src-ckd-162 (title_only)
- topics/ckd/synthesis-index.md: src-ckd-053 (abstract_weighted), src-ckd-054 (abstract_weighted)
...
- topics/fip/synthesis-index.md: src-fip-029 (abstract_weighted), src-fip-030 (abstract_weighted), src-fip-032 (abstract_weighted), src-fip-033 (abstract_weighted), src-fip-034 (abstract_weighted), src-fip-035 (abstract_weighted), src-fip-037 (abstract_weighted), src-fip-038 (abstract_weighted), src-fip-039 (abstract_weighted), src-fip-040 (abstract_weighted), src-fip-041 (abstract_weighted), src-fip-042 (abstract_weighted), src-fip-043 (abstract_weighted), src-fip-044 (abstract_weighted), src-fip-045 (abstract_weighted), src-fip-046 (abstract_weighted), src-fip-047 (abstract_weighted), src-fip-048 (abstract_weighted), src-fip-049 (abstract_weighted)
...
- Re-extract 3 F-grade V2 cards that failed quality gate.
- Review and improve 49 C-grade V2 cards (use `python3 scripts/audit_v2_cards.py --problems`).
