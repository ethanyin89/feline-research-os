---
id: system-health-report-20260506
type: health-check
...
# Vault Health Report, 2026-05-06
...
| Check | Status | Read |
|---|---|---|
| Markdown links | PASS | PASS: checked 779 markdown files, no local link issues found. |
| Query tests | PASS | 93 passed  \|  0 failed  \|  93 total |
...
| Ordinary-user acceptance | PASS | system/health-checks/ordinary-user-acceptance-report-20260506.md; mode=executed; status=pass |
