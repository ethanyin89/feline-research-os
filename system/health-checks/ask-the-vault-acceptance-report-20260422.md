---
id: system-ask-the-vault-acceptance-report-20260422
type: health-check
...
# Ask The Vault Acceptance Report, 2026-04-22

Execution mode: blocked-missing-key:OPENROUTER_API_KEY
Backend: openrouter
Write-back: off
...
Acceptance summary: blocked before query execution.

Blocked reason: `OPENROUTER_API_KEY` is not set in the current shell.
