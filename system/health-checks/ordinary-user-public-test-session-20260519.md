---
id: ordinary-user-public-test-session-20260519
type: health-check
...
# Ordinary User Public Test Session, 2026-05-19

## Test Link

Public URL:

- `https://gain-challenged-bra-offices.trycloudflare.com`

Fallback URLs:

- local machine: `http://localhost:8502`
- same Wi-Fi: `http://192.168.110.44:8502`

This is a temporary Cloudflare quick tunnel. It only works while both processes are running:

1. Streamlit Ask the Vault on port `8502`
2. `cloudflared tunnel --url http://127.0.0.1:8502`
...
| Check | Result |
|---|---|
| local Streamlit health | `http://127.0.0.1:8502/_stcore/health` returned `ok` |
| same-Wi-Fi health | `http://192.168.110.44:8502/_stcore/health` returned `ok` |
| public tunnel health | `https://gain-challenged-bra-offices.trycloudflare.com/_stcore/health` returned `ok` |
...
This is manual public-test-link sample `1/3-10`.

This is also live ordinary-user acceptance sample `1/3-10` for the public-link workflow.
