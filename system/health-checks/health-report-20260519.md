---
id: system-health-report-20260519
type: health-check
...
| Check | Status | Read |
|---|---|---|
| Markdown links | PASS | PASS: checked 1112 markdown files, no local link issues found. |
...
| Ordinary-user acceptance | PASS | system/health-checks/ordinary-user-acceptance-report-20260519.md; mode=route-only; status=route_pass |
