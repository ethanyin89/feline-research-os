---
id: system-health-report-20260609
type: health-check
...
# Vault Health Report, 2026-06-09
...
| Compile trigger | PASS | 61 changed source cards, 97 downstream files |
...
| cancer | 102 | abstract: 34, deep: 55, full: 12, partial: 1 | abstract_weighted: 86, deep_extracted: 12, publisher_verified: 1, source_checked: 2, title_only: 1 |
...
- topics/cancer/current-state-dashboard.md: src-cancer-052 (abstract_weighted), src-cancer-054 (abstract_weighted), src-cancer-055 (abstract_weighted), src-cancer-056 (abstract_weighted), src-cancer-060 (abstract_weighted), src-cancer-061 (abstract_weighted), src-cancer-064 (abstract_weighted)
...
- topics/cancer/oral-squamous-cell-carcinoma.md: src-cancer-046 (abstract_weighted), src-cancer-031 (abstract_weighted), src-cancer-021 (abstract_weighted), src-cancer-055 (abstract_weighted), src-cancer-061 (abstract_weighted), src-cancer-071 (abstract_weighted), src-cancer-073 (abstract_weighted), src-cancer-074 (abstract_weighted), src-cancer-080 (abstract_weighted)
