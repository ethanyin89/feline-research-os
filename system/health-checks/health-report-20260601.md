---
id: system-health-report-20260601
type: health-check
...
# Vault Health Report, 2026-06-01
...
| Check | Status | Read |
|---|---|---|
| Markdown links | PASS | PASS: checked 1284 markdown files, no local link issues found. |
...
| Compile trigger | PASS | 102 changed source cards, 42 downstream files |
...
| cancer | 102 | abstract: 56, full: 6, partial: 40 | abstract_weighted: 65, deep_extracted: 6, publisher_verified: 1, title_only: 30 |
