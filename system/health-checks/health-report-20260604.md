---
id: system-health-report-20260604
type: health-check
...
| Check | Status | Read |
|---|---|---|
| Markdown links | PASS | PASS: checked 1298 markdown files, no local link issues found. |
...
| Compile trigger | PASS | 26 changed source cards, 6 downstream files |
...
| cancer | 102 | abstract: 93, full: 6, partial: 3 | abstract_weighted: 91, deep_extracted: 6, duplicate: 1, not_pubmed_indexed: 3, publisher_verified: 1 |
