---
id: src-obesity-078-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-obesity-078]
language: zh
...
# src-obesity-078 Structured Abstract Extraction, Round 1
...
| Endpoint / theme signals | weight, obesity, overweight, prevention |

Short abstract lead for scope check only:

> Obesity is the most common nutritionally related disease of dogs and cats. Several of the important health problems tha...
...
- Branch fit: weight, obesity, overweight, prevention
