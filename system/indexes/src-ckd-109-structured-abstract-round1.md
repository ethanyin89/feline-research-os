---
id: src-ckd-109-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-ckd-109]
language: zh
...
# src-ckd-109 Structured Abstract Extraction, Round 1
...
| Detected section labels | background, animals, results, conclusions |
| Endpoint / theme signals | biomarker, chronic kidney disease |

Short abstract lead for scope check only:

> BACKGROUND: Chronic kidney disease (CKD) is one of the most common diseases occurring in cats. It is characterized by r...
