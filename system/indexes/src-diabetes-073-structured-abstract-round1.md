---
id: src-diabetes-073-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-diabetes-073]
language: zh
...
# src-diabetes-073 Structured Abstract Extraction, Round 1
...
| Population / sample signal | 13 cats |
| Detected section labels | results |
| Endpoint / theme signals | insulin, glucose, remission |

Short abstract lead for scope check only:

> Abstract The goals of this study were to compare the efficacy of once-daily administered Glargine insulin to twice-dail...
