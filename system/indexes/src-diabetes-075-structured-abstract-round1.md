---
id: src-diabetes-075-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-diabetes-075]
language: zh
...
# src-diabetes-075 Structured Abstract Extraction, Round 1
...
| Field | Value |
|---|---|
| Source | `src-diabetes-075` |
| Title | Feline Acromegaly |
...
> Practical relevance Clinicians who deal with diabetic cats can have mixed experiences. Some patients are ‘textbook case...
