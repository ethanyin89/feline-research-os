---
id: src-ckd-172-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-ckd-172]
language: zh
...
# src-ckd-172 Structured Abstract Extraction, Round 1
...
| Population / sample signal | 29 cats |
| Detected section labels | aim, methods, results, conclusions |
| Endpoint / theme signals | chronic kidney disease |

Short abstract lead for scope check only:

> Objectives The aim of the present study was to assess the effect of gabapentin on blood pressure (BP) in cats with and...
