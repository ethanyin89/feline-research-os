---
id: src-obesity-087-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-obesity-087]
language: zh
...
# src-obesity-087 Structured Abstract Extraction, Round 1
...
| Endpoint / theme signals | weight |

Short abstract lead for scope check only:

> A randomised, single-blinded, positively controlled, field trial for weight loss in obese client-owned cats was underta...
