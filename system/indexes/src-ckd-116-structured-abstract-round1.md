---
id: src-ckd-116-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-ckd-116]
language: zh
...
# src-ckd-116 Structured Abstract Extraction, Round 1
...
| Population / sample signal | 140 cats |
| Detected section labels | results |
| Endpoint / theme signals | chronic kidney disease, proteinuria |

Short abstract lead for scope check only:

> This study aimed at understanding the reasons veterinarians conduct a urinary protein/creatinine ratio (UPCR) in cats,...
...
- Branch fit: chronic kidney disease, proteinuria
