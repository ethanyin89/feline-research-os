---
id: src-obesity-038-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-obesity-038]
language: zh
...
# src-obesity-038 Structured Abstract Extraction, Round 1
...
| Field | Value |
|---|---|
| Source | `src-obesity-038` |
| Title | Macronutrients in Feline Health |
| DOI | `10.1016/j.cvsm.2014.03.007` |
...
| Endpoint / theme signals | body condition |

Short abstract lead for scope check only:

> Dietary macronutrients include protein, fat, and carbohydrates. Current nutritional recommendations establish minimums...
