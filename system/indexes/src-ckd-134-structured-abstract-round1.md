---
id: src-ckd-134-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-ckd-134]
language: zh
...
# src-ckd-134 Structured Abstract Extraction, Round 1
...
| Endpoint / theme signals | survival, risk factor |

Short abstract lead for scope check only:

> Traditional thinking views apparently non-programmed disruptions of aging, which medical science calls geriatric diseas...
...
- Branch fit: survival, risk factor
