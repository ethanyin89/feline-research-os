---
id: src-obesity-060-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-obesity-060]
language: zh
...
# src-obesity-060 Structured Abstract Extraction, Round 1
...
| Endpoint / theme signals | weight, obesity, overweight, microbiota |

Short abstract lead for scope check only:

> Abstract Surveys report that 25–57 % of cats are overweight or obese. The most evinced cause is neutering. Weight loss...
...
- Branch fit: weight, obesity, overweight, microbiota
