---
id: src-ckd-171-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-ckd-171]
language: zh
...
# src-ckd-171 Structured Abstract Extraction, Round 1
...
| Container | Virchows Archiv B Cell Pathology Including Molecular Pathology |
| Year | 1987 |
...
| Population / sample signal | 19 cats |
| Detected section labels | none mechanically detected |
| Endpoint / theme signals | none mechanically detected |

Short abstract lead for scope check only:

> We have compared the pattern of lectin staining with the ultrastructural features of kidneys from normal cats and 19 ca...
