---
id: src-ckd-104-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-ckd-104]
language: zh
...
# src-ckd-104 Structured Abstract Extraction, Round 1
...
| Population / sample signal | 618 cats |
| Detected section labels | none mechanically detected |
| Endpoint / theme signals | azotemia, chronic kidney disease, mineralization, phosphate |

Short abstract lead for scope check only:

> Bicarbonate deficiency is a common complication of acute kidney injury (AKI) and chronic kidney disease (CKD), resultin...
...
- Branch fit: azotemia, chronic kidney disease, mineralization, phosphate
