---
id: src-ckd-037-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-ckd-037]
language: zh
...
# src-ckd-037 Structured Abstract Extraction, Round 1
...
| Endpoint / theme signals | survival, chronic kidney disease |

Short abstract lead for scope check only:

> Feline morbillivirus (FeMV) was first isolated in stray cats in Hong Kong in 2012. Since its discovery, the virus has b...
...
- Branch fit: survival, chronic kidney disease
