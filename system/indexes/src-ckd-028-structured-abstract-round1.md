---
id: src-ckd-028-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-ckd-028]
language: zh
...
# src-ckd-028 Structured Abstract Extraction, Round 1
...
| Endpoint / theme signals | survival, weight, chronic kidney disease, phosphorus |

Short abstract lead for scope check only:

> Abstract Background Chronic kidney disease (CKD) and acute decompensation of CKD (ACKD) are common in cats. Objectives...
...
- Branch fit: survival, weight, chronic kidney disease, phosphorus
