---
id: src-ckd-098-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-ckd-098]
language: zh
...
# src-ckd-098 Structured Abstract Extraction, Round 1
...
| Population / sample signal | 661 cats |
| Detected section labels | methods, results, conclusions |
| Endpoint / theme signals | none mechanically detected |

Short abstract lead for scope check only:

> Objectives The medullary rim sign (MRS) is an ultrasonographic (US) feature identified in normal and diseased feline ki...
