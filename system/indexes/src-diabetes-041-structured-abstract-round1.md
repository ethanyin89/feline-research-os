---
id: src-diabetes-041-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-diabetes-041]
language: zh
...
# src-diabetes-041 Structured Abstract Extraction, Round 1
...
| Container | Bulletin of University of Agricultural Sciences and Veterinary Medicine Cluj-Napoca. Veterinary Medicine |
| Year | 2015 |
...
> Accurate species identification from Whole Genome Sequencing (WGS) data remains challenging, particularly for closely r...
