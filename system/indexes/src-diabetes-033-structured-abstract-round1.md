---
id: src-diabetes-033-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-diabetes-033]
language: zh
...
# src-diabetes-033 Structured Abstract Extraction, Round 1
...
| Detected section labels | animals, results, conclusions |
| Endpoint / theme signals | insulin, glucose, survival |

Short abstract lead for scope check only:

> Abstract Objectives To determine whether basal‐bolus administration of glargine insulin is a safe and effective alterna...
