---
id: src-obesity-050-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-obesity-050]
language: zh
...
# src-obesity-050 Structured Abstract Extraction, Round 1
...
| Endpoint / theme signals | weight, obesity, overweight, pathology |

Short abstract lead for scope check only:

> Obesity is defined as the excessive accumulation of adipose tissue and is currently the most common disease in cats. Si...
...
- Branch fit: weight, obesity, overweight, pathology
