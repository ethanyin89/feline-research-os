---
id: src-ckd-050-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-ckd-050]
language: zh
...
# src-ckd-050 Structured Abstract Extraction, Round 1
...
| Detected section labels | aim, background, results, conclusions |
| Endpoint / theme signals | pathology, chronic kidney disease, cytokine |

Short abstract lead for scope check only:

> BACKGROUND: Chronic kidney disease (CKD) is common in geriatric cats, and the most prevalent pathology is chronic tubul...
...
- Branch fit: pathology, chronic kidney disease, cytokine
