---
id: src-obesity-030-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-obesity-030]
language: zh
...
# src-obesity-030 Structured Abstract Extraction, Round 1
...
| Detected section labels | animals, methods, results |
| Endpoint / theme signals | weight, obesity, overweight |

Short abstract lead for scope check only:

> Obesity is currently one of the major medical problems affecting humans and companion animals, including cats; however,...
