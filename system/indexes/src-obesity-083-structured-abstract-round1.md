---
id: src-obesity-083-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-obesity-083]
language: zh
...
# src-obesity-083 Structured Abstract Extraction, Round 1
...
| Detected section labels | objective, methods, results |
| Endpoint / theme signals | weight, body condition |

Short abstract lead for scope check only:

> Nutritional assessment guidelines recommend that veterinary teams assess the body composition of pets at every visit. T...
...
- Branch fit: weight, body condition
