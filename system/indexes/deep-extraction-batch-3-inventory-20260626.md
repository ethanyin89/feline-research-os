...
- Valid desktop deep extracts represented in repo: 4/4 processed.
- Canonical source cards linked to raw artifacts: 4/4 processed.
- Duplicate/alias cards linked where relevant: 2/2 alias groups.
- Initial passage-library coverage: 4/4 processed.
