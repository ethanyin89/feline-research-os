---
id: src-diabetes-102-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-diabetes-102]
language: zh
...
# src-diabetes-102 Structured Abstract Extraction, Round 1
...
| Population / sample signal | 44 cats |
| Detected section labels | results |
| Endpoint / theme signals | none mechanically detected |

Short abstract lead for scope check only:

> Pancreatic tissues from 93 adult domestic cats with no clinicopathologic evidence of overt diabetes mellitus were exami...
