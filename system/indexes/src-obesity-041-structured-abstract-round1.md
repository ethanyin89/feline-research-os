---
id: src-obesity-041-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-obesity-041]
language: zh
...
# src-obesity-041 Structured Abstract Extraction, Round 1
...
| Population / sample signal | 18 cats |
| Detected section labels | objective |
| Endpoint / theme signals | weight, body condition, obesity, overweight, risk factor, activity |

Short abstract lead for scope check only:

> Obesity is regarded as the most common form of malnutrition seen by veterinarians. An estimated 25% of cats are describ...
