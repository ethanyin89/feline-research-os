---
id: src-diabetes-067-structured-abstract-round1
type: system
topic: content-pipeline
question_type: structured-abstract-extraction
source_ids: [src-diabetes-067]
language: zh
...
# src-diabetes-067 Structured Abstract Extraction, Round 1
...
| Population / sample signal | 563 cats |
| Detected section labels | background, animals, methods, results, conclusions |
| Endpoint / theme signals | weight, risk factor |

Short abstract lead for scope check only:

> Abstract Background Diabetes mellitus (DM) is a common endocrine disease of cats. The prevalence of DM in cats in Engla...
