...
tags: [cancer, androgen, receptor, foxa1, coexpression, define, luminal-ar, subtype]
links:
...
evidence_policy:
  quoted_fact:
    ...
    - "Crossref container: BMC Cancer; year: 2019."
...
Candidate cancer source from sheet row 59. Use it for triage until abstract or full-text extraction proves a stronger role.
