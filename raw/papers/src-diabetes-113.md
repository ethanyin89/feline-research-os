...
tags: [diabetes, evaluation, routine, hematology, profile, results, fructosamine, thyroxine]
links:
  doi: "10.2460/javma.243.9.1302"
  url: "https://doi.org/10.2460/javma.243.9.1302"
  local_assets: ["../../raw/deep-extractions/ext-src-diabetes-113.md"]
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of the American Veterinary Medical Association; year: 2013."
...
Abstract lead for scope check only: Abstract Objective —To compare results of hematologic testing in nondiabetic and diabetic cats to identify possible indicators of alterations in long-term glucose control. Design...

## One-Line Summary

Candidate diabetes source from sheet row 125. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Evaluation of routine hematology profile results and fructosamine, thyroxine, insulin, and proinsulin concentrations in lean, overweight, obese, and diabetic cats.
- The intake sheet locator is: 10.2460/javma.243.9.1302.
