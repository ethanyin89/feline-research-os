...
tags: [diabetes, comparison, insulin, infusion, protocols, management, diabetic, ketoacidosis]
links:
...
evidence_policy:
  quoted_fact:
    ...
    - "Crossref container: Journal of Veterinary Emergency and Critical Care; year: 2024."
...
Abstract lead for scope check only: Abstract Objective Describe the use of fixed‐rate intravenous insulin infusions (FRIs) in cats and dogs with diabetic ketoacidosis (DKA) and determine if this is associated with f...

## One-Line Summary

Candidate diabetes source from sheet row 122. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Comparison of insulin infusion protocols for management of canine and feline diabetic ketoacidosis.
- The intake sheet locator is: 10.1111/vec.13354.
