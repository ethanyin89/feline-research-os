...
tags: [diabetes, clinical, usefulness, fructosamine, measurements, diagnosing, monitoring]
links:
  doi: "10.1111/j.1748-5827.1996.tb01940.x"
  url: "https://doi.org/10.1111/j.1748-5827.1996.tb01940.x"
  local_assets: ["../../raw/deep-extractions/ext-src-diabetes-039.md"]
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of Small Animal Practice; year: 1996."
...
Abstract lead for scope check only: ABSTRACT Fructosamines are glycated serum proteins that reflect long‐term serum glucose concentrations in humans and several animal species. In the present study, blood samples we...

## One-Line Summary

Candidate diabetes source from sheet row 51. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Clinical usefulness of fructosamine measurements in diagnosing and monitoring feline diabetes mellitus.
- The intake sheet locator is: 10.1111/j.1748-5827.1996.tb01940.x.
