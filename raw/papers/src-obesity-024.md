...
tags: [obesity, problem, success]
links:
  doi: "10.1177/1098612x12444999"
  url: "https://doi.org/10.1177/1098612x12444999"
  local_assets: []
evidence_policy:
  quoted_fact:
...
Abstract lead for scope check only: Practical relevance: Obesity is the most common unhealthy nutritional condition that is recognized in cats. Documented associated health risks include diabetes mellitus, lameness,...

## One-Line Summary

Candidate obesity source from sheet row 155. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: From Problem to Success.
- The intake sheet locator is: 10.1177/1098612x12444999.
