...
tags: [cancer, activation, akt, mammary, carcinoma, new, prognostic, factor]
links:
  doi: ""
...
evidence_policy:
  quoted_fact:
    - "The intake sheet lists this title: Activation of AKT in feline mammary carcinoma: A new prognostic factor for feline mammary tumours."
    - "The intake sheet locator is: https://www.sciencedirect.com/science/article/abs/pii/S109002331000448X?via%3Dihub."
...
Candidate cancer source from sheet row 96. Use it for triage until abstract or full-text extraction proves a stronger role.
