...
tags: [obesity, long-term, follow-up, after, weight, management, obese]
links:
  doi: "10.1017/jns.2014.36"
  url: "https://doi.org/10.1017/jns.2014.36"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of Nutritional Science; year: 2014."
...
Abstract lead for scope check only: Abstract Feline obesity is a prevalent medical disease and the main therapeutic strategy is dietary energy restriction. However, at present there are no data regarding long-term o...

## One-Line Summary

Candidate obesity source from sheet row 218. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Long-term follow-up after weight management in obese cats*.
- The intake sheet locator is: 10.1017/jns.2014.36.
