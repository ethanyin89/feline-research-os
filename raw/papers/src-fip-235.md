...
links:
  ...
  url: "https://doi.org/10.1155/2011/609465"
  pmc: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3265309/"
  pmcid: "PMC3265309"
  local_assets:
...
methods_summary: "A comparative virology review examining the genetics, cell receptor tropism, and pathobiology of Feline Coronavirus (FCoV) and Canine Coronavirus (CCoV). The review synthesizes data on genotype classification (Genotypes I and II), highlighting the recombination events between CCoV, FCoV, and transmissible gastroenteritis virus (TGEV) that shape host tropism and disease presentation (e.g. FIP in cats)."
evidence_policy:
  quoted_fact:
  ...
  source_supported_conclusion:
    - "CCoV and FCoV share high genetic homology, and historical recombination events between canine and feline coronaviruses have generated type II strains that affect host cell tropism."
    - "Studying the genetic similarities and pathobiological overlap between canine and feline coronaviruses helps elucidate the mechanisms of feline infectious peritonitis (FIP)."
  llm_inference:
    - "Therapeutic strategies targeting coronavirus replication, such as protease or polymerase inhibitors, may show broad cross-species efficacy in both feline FIP and canine coronavirus infections due to conserved structural mechanisms."
  # V2 enhanced fields
  study_design: "综述，比较猫冠状病毒（FCoV）和犬冠状病毒（CCoV）的遗传学、细胞受体嗜性和病理生物学"
  core_argument: "FCoV 和 CCoV 共享高度遗传同源性——历史重组事件产生了 II 型毒株，影响宿主细胞嗜性和受体依赖性（氨肽酶 N）"
  implicit_premise: "假设跨物种遗传同源性意味着治疗靶点保守；假设体外受体结合数据可外推至体内致病性"
  unexpected_finding: "I 型 FCoV 的细胞受体至今未知——尽管 I 型在自然感染中占主导地位"
  title_gap: "标题说猫犬冠状病毒的共同遗传和病理生物学特征，但真正发现是知识悖论：I 型 FCoV 在自然感染中占主导地位但其细胞受体至今未知——最常见毒株的基础病毒学仍是空白"
  evidence_boundary: "2011 年综述，不包含后来的 GS-441524 或莫努匹韦疗效数据；比较病毒学而非临床治疗指南"
---
