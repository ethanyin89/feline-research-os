...
tags: [diabetes, routine, kidney, variables, glomerular, filtration, rate, urinary]
links:
  doi: "10.1177/1098612x14559788"
  url: "https://doi.org/10.1177/1098612x14559788"
  local_assets: ["../../raw/deep-extractions/ext-src-diabetes-086.md"]
evidence_policy:
  quoted_fact:
...
Abstract lead for scope check only: Objectives Diabetic kidney disease (DKD) is a frequent and serious complication in human diabetic patients, but data are limited in cats. This study was undertaken to assess wheth...

## One-Line Summary

Candidate diabetes source from sheet row 98. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Routine kidney variables, glomerular filtration rate and urinary cystatin C in cats with diabetes mellitus, cats with chronic kidney disease and healthy cats.
- The intake sheet locator is: 10.1177/1098612x14559788.
