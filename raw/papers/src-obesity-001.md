...
diseases: [obesity]
models: []
endpoints: [prevalence, risk-factors, body-condition-assessment]
jurisdictions: []
...
links:
  ...
  url: "https://doi.org/10.17221/145/2015-VETMED"
  local_assets: []
evidence_policy:
  quoted_fact:
...
This source is the cleanest early obesity-shell candidate in the sheet because the title is explicitly feline-specific and broad enough to cover the first module architecture. It should be read before creating obesity mechanism, recognition, or assessment pages because it likely helps decide what the module is actually about.

For now, its value is structural. It says the obesity module should not begin as a narrow diet page or a diabetes appendix. The title points to at least five separate lanes: how common obesity is, what raises risk, what pathogenesis logic matters, which associated conditions belong nearby, and how obesity should be assessed.
...
- figures to capture: unknown until full text is read
- why these matter: assessment figures or body-condition tools may be useful only after label verification
...
- models:
- endpoints: prevalence, risk factors, body condition assessment
- mechanisms: insulin resistance, adiposity
- regulations:
