...
id: src-obesity-046
type: source
title: "Effect of trans-fat, fructose and monosodium glutamate feeding on feline weight gain, adiposity, insulin sensitivity, adipokine and lipid profile"
source_kind: paper
species: feline
diseases: [obesity]
models: []
...
tags: [obesity, effect, trans-fat, fructose, monosodium, glutamate, feeding, weight]
links:
  doi: "10.1017/s000711451000588x"
  url: "https://doi.org/10.1017/s000711451000588x"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: British Journal of Nutrition; year: 2011."
...
Abstract lead for scope check only: The incidence of obesity and type 2 diabetes mellitus (T2DM) is increasing, and new experimental models are required to investigate the diverse aspects of these polygenic diseases...

## One-Line Summary

Candidate obesity source from sheet row 182. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Effect of trans-fat, fructose and monosodium glutamate feeding on feline weight gain, adiposity, insulin sensitivity, adipokine and lipid profile.
- The intake sheet locator is: 10.1017/s000711451000588x.
