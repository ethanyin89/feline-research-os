...
tags: [obesity, association, between, gut, microbiota, metabolic, health, status]
links:
  doi: "10.3390/ani14172524"
  url: "https://doi.org/10.3390/ani14172524"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Animals; year: 2024."
...
Abstract lead for scope check only: Obesity is a major public health concern in both humans and animals, leading to several metabolic complications. Recent human studies have classified obesity into two phenotypes,...

## One-Line Summary

Candidate obesity source from sheet row 186. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Association between Gut Microbiota and Metabolic Health and Obesity Status in Cats.
- The intake sheet locator is: 10.3390/ani14172524.
