...
id: src-obesity-012
type: source
title: "Prevalence and risk factors for feline obesity in a first opinion practice in Glasgow, Scotland"
source_kind: paper
species: feline
diseases: [obesity]
models: []
...
tags: [obesity, prevalence, risk, factors, first, opinion, practice, glasgow]
links:
  doi: "10.1016/j.jfms.2010.05.011"
  url: "https://doi.org/10.1016/j.jfms.2010.05.011"
  local_assets: []
evidence_policy:
  quoted_fact:
...
Abstract lead for scope check only: A cross-sectional questionnaire study of cat owners registered with a first opinion veterinary practice was undertaken in July 2008. The body condition score (BCS) of the cats was...

## One-Line Summary

Candidate obesity source from sheet row 141. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Prevalence and risk factors for feline obesity in a first opinion practice in Glasgow, Scotland.
- The intake sheet locator is: 10.1016/j.jfms.2010.05.011.
