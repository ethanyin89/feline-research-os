...
id: src-diabetes-049
type: source
title: "Evaluation of insulin-like growth factor-1, total thyroxine, feline pancreas-specific lipase and urinary corticoid-to-creatinine ratio in cats with diabetes mellitus in Switzerland and the Netherlands"
source_kind: paper
species: feline
...
tags: [diabetes, evaluation, insulin-like, growth, factor-1, total, thyroxine, pancreas-specific]
links:
  doi: "10.1177/1098612x16664390"
  url: "https://doi.org/10.1177/1098612x16664390"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of Feline Medicine and Surgery; year: 2017."
...
Abstract lead for scope check only: Objectives The aim of the study was to evaluate circulating insulin-like growth factor-1 (IGF-1), feline pancreas-specific lipase (fPLI) and total thyroxine (TT4) concentrations a...

## One-Line Summary

Candidate diabetes source from sheet row 61. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Evaluation of insulin-like growth factor-1, total thyroxine, feline pancreas-specific lipase and urinary corticoid-to-creatinine ratio in cats with diabetes mellitus in Switzerland and the Netherlands.
- The intake sheet locator is: 10.1177/1098612x16664390.
