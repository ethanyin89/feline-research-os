...
tags: [diabetes, mapping, susceptibility, loci, domestic, cat, breed, unusually]
links:
  doi: "10.3390/genes11111369"
  url: "https://doi.org/10.3390/genes11111369"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Genes; year: 2020."
...
Abstract lead for scope check only: Genetic variants that are associated with susceptibility to type 2 diabetes (T2D) are important for identification of individuals at risk and can provide insights into the molecul...

## One-Line Summary

Candidate diabetes source from sheet row 128. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Mapping of Diabetes Susceptibility Loci in a Domestic Cat Breed with an Unusually High Incidence of Diabetes Mellitus.
- The intake sheet locator is: 10.3390/genes11111369.
