...
id: src-obesity-070
type: source
title: "Characterization of feline nonsteroidal anti-inflammatory drug activated gene-1 (fNAG-1) and its protective function in kidney cells"
source_kind: paper
species: feline
diseases: [obesity]
models: []
...
tags: [obesity, characterization, nonsteroidal, anti-inflammatory, drug, activated, gene-1, fnag-1]
links:
  doi: "10.1186/s12917-025-04781-1"
  url: "https://doi.org/10.1186/s12917-025-04781-1"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: BMC Veterinary Research; year: 2025."
...
Abstract lead for scope check only: Abstract Background Domestic cats are susceptible to obesity and chronic renal failure, leading to significant health risks. Nonsteroidal anti-inflammatory drug-activated gene (NA...

## One-Line Summary

Candidate obesity source from sheet row 211. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Characterization of feline nonsteroidal anti-inflammatory drug activated gene-1 (fNAG-1) and its protective function in kidney cells.
- The intake sheet locator is: 10.1186/s12917-025-04781-1.
