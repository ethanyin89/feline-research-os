...
id: src-obesity-031
type: source
title: "Adipocyte-Derived Adipokines and Other Obesity-Associated Molecules in Feline Mammary Cancer"
source_kind: paper
species: feline
diseases: [obesity]
models: []
...
tags: [obesity, adipocyte-derived, adipokines, other, obesity-associated, molecules, mammary, cancer]
links:
  doi: "10.3390/biomedicines11082309"
  url: "https://doi.org/10.3390/biomedicines11082309"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Biomedicines; year: 2023."
...
Abstract lead for scope check only: Obesity has been identified as a serious health concern in domestic cats. Feline mammary cancer (FMC) is also a concern, as it is highly prevalent and aggressive. Considering the...

## One-Line Summary

Candidate obesity source from sheet row 163. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Adipocyte-Derived Adipokines and Other Obesity-Associated Molecules in Feline Mammary Cancer.
- The intake sheet locator is: 10.3390/biomedicines11082309.
