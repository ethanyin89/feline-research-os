...
evidence_policy:
  ...
  # V2 enhanced fields
  study_design: "实验性挑战研究，使用接种了改良活疫苗的家猫，评估其针对异源野外流行毒株的免疫反应（2021 年）"
  core_argument: "FCV 疫苗保护不能仅靠中和抗体滴度评估——改良活疫苗接种的猫在缺乏体液交叉中和抗体的情况下，仍能产生针对异源毒株的显著 Th1 细胞免疫应答"
  implicit_premise: "细胞免疫反应的存在及其测定能反映疫苗诱导的保护效果，且不同免疫指标（细胞免疫与体液免疫）对保护作用有独立贡献"
  title_gap: "标题强调疫苗诱导细胞免疫，但真正发现是细胞免疫能在缺乏体液交叉中和的情况下存在——提示传统中和抗体检测可能低估疫苗效益"
  evidence_boundary: "实验性挑战研究，样本量有限；未评价疫苗对自然感染条件下临床保护率的直接影响；未研究免疫持续性或多亚型交叉保护的完整谱系"
