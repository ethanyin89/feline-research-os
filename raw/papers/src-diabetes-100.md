...
tags: [diabetes, assessment, association, between, chronic, kidney, disease, adult]
links:
  doi: "10.1111/jvim.15559"
  url: "https://doi.org/10.1111/jvim.15559"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of Veterinary Internal Medicine; year: 2019."
...
Abstract lead for scope check only: Abstract Background Diabetes mellitus is the main cause of chronic kidney disease (CKD) in humans. The relationship between the 2 diseases in cats is unclear. Objective To assess...

## One-Line Summary

Candidate diabetes source from sheet row 112. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Assessment of the association between diabetes mellitus and chronic kidney disease in adult cats.
- The intake sheet locator is: 10.1111/jvim.15559.
