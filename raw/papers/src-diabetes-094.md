...
id: src-diabetes-094
type: source
title: "Time trends and risk factors for diabetes mellitus in cats presented to veterinary teaching hospitals"
source_kind: paper
species: feline
...
tags: [diabetes, time, trends, risk, factors, presented, veterinary, teaching]
links:
  doi: "10.1016/j.jfms.2007.02.004"
  url: "https://doi.org/10.1016/j.jfms.2007.02.004"
  local_assets: []
evidence_policy:
  quoted_fact:
...
Abstract lead for scope check only: Veterinary Medical Data Base records of cats with diabetes mellitus (DM) from 1970 through 1999 were reviewed to identify trends in hospital prevalence of DM and potential host ri...

## One-Line Summary

Candidate diabetes source from sheet row 106. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Time trends and risk factors for diabetes mellitus in cats presented to veterinary teaching hospitals.
- The intake sheet locator is: 10.1016/j.jfms.2007.02.004.
