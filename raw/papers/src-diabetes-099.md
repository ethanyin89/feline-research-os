...
tags: [diabetes, intensive, blood, glucose, control, safe, effective, diabetic]
links:
  doi: "10.1016/j.jfms.2009.04.010"
  url: "https://doi.org/10.1016/j.jfms.2009.04.010"
  local_assets: []
evidence_policy:
  quoted_fact:
...
Abstract lead for scope check only: Human diabetic patients routinely self-adjust their insulin dose using a protocol and home monitoring, and perform equally well or outperform physician directed adjustments. The o...

## One-Line Summary

Candidate diabetes source from sheet row 111. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Intensive blood glucose control is safe and effective in diabetic cats using home monitoring and treatment with glargine.
- The intake sheet locator is: 10.1016/j.jfms.2009.04.010.
