...
id: src-obesity-065
type: source
title: "Evidence of obesity-induced inflammatory changes in client-owned cats"
source_kind: paper
species: feline
diseases: [obesity]
models: []
...
tags: [obesity, evidence, obesity-induced, inflammatory, changes, client-owned]
links:
  doi: "10.14202/vetworld.2024.1685-1692"
  url: "https://doi.org/10.14202/vetworld.2024.1685-1692"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Veterinary World; year: 2024."
...
Abstract lead for scope check only: Background and Aim: Insulin resistance and type 2 diabetes mellitus are common health issues in obese (OB) cats. In humans, obesity leads to alterations in adipokine and proinflam...

## One-Line Summary

Candidate obesity source from sheet row 204. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Evidence of obesity-induced inflammatory changes in client-owned cats.
- The intake sheet locator is: 10.14202/vetworld.2024.1685-1692.
