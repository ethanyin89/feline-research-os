...
id: src-cancer-097
type: source
title: "Development of a Genome-Wide Oligonucleotide Microarray Platform for Detection of DNA Copy Number Aberrations in Feline Cancers"
source_kind: paper
species: feline
diseases: [cancer]
models: []
...
evidence_policy:
  ...
  # V2 enhanced fields
  study_design: "方法学开发研究（2020 年 Vet Sci），全基因组寡核苷酸微阵列平台开发，NC State Thomas/Breen 实验室"
  core_argument: "全基因组微阵列平台使猫癌症的 DNA 拷贝数异常检测成为可能——猫是人类疾病的重要模型——共享保守基因组区域——该平台为猫癌症基因组学研究提供基础工具"
