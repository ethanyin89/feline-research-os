...
id: src-obesity-043
type: source
title: "Associations of body condition score with health conditions related to overweight and obesity in cats"
source_kind: paper
species: feline
diseases: [obesity]
models: []
...
tags: [obesity, associations, body, condition, score, health, conditions, related]
links:
  doi: "10.1111/jsap.12905"
  url: "https://doi.org/10.1111/jsap.12905"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of Small Animal Practice; year: 2018."
...
Abstract lead for scope check only: Objectives To explore the associations of cat body condition score with various health conditions, such as diabetes mellitus, dermatological conditions and hypertension, that have...

## One-Line Summary

Candidate obesity source from sheet row 179. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Associations of body condition score with health conditions related to overweight and obesity in cats.
- The intake sheet locator is: 10.1111/jsap.12905.
