...
evidence_policy:
  ...
  title_gap: "标题说血清学研究，但 1976 年发表意味着这是现代复合诊断之前的方法——真正价值是展示为什么单一抗体滴度不能成为诊断捷径，以及为什么现代诊断架构保持复合性"
  evidence_boundary: "历史血清学研究，现代操作价值有限；1976 年检测方法与当前技术不同；不能直接推断现代抗体滴度解释规则"
---
