...
id: src-diabetes-055
type: source
title: "Insulin sensitivity in normal and diabetic cats"
source_kind: paper
species: feline
...
Abstract lead for scope check only: Estimates of in vivo insulin sensitivity (S I ) can be derived from minimal model analysis of a frequently sampled intravenous glucose tolerance test (FSIVGTT). Modification of th...

## One-Line Summary

Candidate diabetes source from sheet row 67. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Insulin sensitivity in normal and diabetic cats.
- The intake sheet locator is: 10.1016/s1098-612x(99)90067-0.
