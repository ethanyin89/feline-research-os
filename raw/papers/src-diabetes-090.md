...
tags: [diabetes, pasireotide, medical, management, hypersomatotropism]
links:
  doi: "10.1111/jvim.12608"
  url: "https://doi.org/10.1111/jvim.12608"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of Veterinary Internal Medicine; year: 2015."
...
Abstract lead for scope check only: Abstract Background Feline hypersomatotropism (HST) is a cause of diabetes mellitus in cats. Pasireotide is a novel multireceptor ligand somatostatin analog that improves biochemi...

## One-Line Summary

Candidate diabetes source from sheet row 102. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Pasireotide for the Medical Management of Feline Hypersomatotropism.
- The intake sheet locator is: 10.1111/jvim.12608.
