...
tags: [diabetes, comorbidities, recognition, diagnosis, management, cushingoid, diabetic]
links:
...
Abstract lead for scope check only: Practical relevance: Diabetes mellitus (DM) is a common feline endocrinopathy, and is often driven by underlying insulin resistance with associated pancreatic beta (β)-cell dysfun...

## One-Line Summary

Candidate diabetes source from sheet row 46. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Feline comorbidities: Recognition, diagnosis and management of the cushingoid diabetic.
- The intake sheet locator is: 10.1177/1098612x20979507.
