...
tags: [diabetes, determination, serum, fpli, concentrations]
links:
  doi: "10.1016/j.jfms.2007.04.007"
  url: "https://doi.org/10.1016/j.jfms.2007.04.007"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of Feline Medicine and Surgery; year: 2008."
...
Abstract lead for scope check only: Diabetes mellitus (DM) is one of the most common feline endocrinopathies. Pancreatitis is a reported cause for poor control of DM in cats; however, its prevalence in diabetic cats...

## One-Line Summary

Candidate diabetes source from sheet row 70. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Determination of serum fPLI concentrations in cats with diabetes mellitus.
- The intake sheet locator is: 10.1016/j.jfms.2007.04.007.
