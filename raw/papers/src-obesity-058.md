...
tags: [obesity, bacterial, fecal, microbiota, only, minimally, affected, standardized]
links:
  doi: "10.1186/s12917-020-02318-2"
  url: "https://doi.org/10.1186/s12917-020-02318-2"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: BMC Veterinary Research; year: 2020."
...
Abstract lead for scope check only: Abstract Background Research in humans and mice suggests that obesity influences the abundance and diversity of gastrointestinal (GI) microbiota, and that an “obese microbiome” in...

## One-Line Summary

Candidate obesity source from sheet row 196. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Bacterial fecal microbiota is only minimally affected by a standardized weight loss plan in obese cats.
- The intake sheet locator is: 10.1186/s12917-020-02318-2.
