...
id: src-diabetes-029
type: source
title: "Oxidative stress and innate immunity in feline patients with diabetes mellitus: the role of nutrition"
source_kind: paper
species: feline
...
tags: [diabetes, oxidative, stress, innate, immunity, patients, role, nutrition]
links:
  doi: "10.1016/j.jfms.2008.07.004"
  url: "https://doi.org/10.1016/j.jfms.2008.07.004"
  local_assets: []
evidence_policy:
  quoted_fact:
...
Abstract lead for scope check only: This study was undertaken to test the hypothesis that oxidative stress is increased and neutrophil function is decreased in cats with diabetes mellitus (DM). Measures of oxidative...

## One-Line Summary

Candidate diabetes source from sheet row 37. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Oxidative stress and innate immunity in feline patients with diabetes mellitus: the role of nutrition.
- The intake sheet locator is: 10.1016/j.jfms.2008.07.004.
