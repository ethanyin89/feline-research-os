...
id: src-obesity-041
type: source
title: "Using Environmental and Feeding Enrichment to Facilitate Feline Weight Loss"
source_kind: paper
species: feline
diseases: [obesity]
models: []
...
tags: [obesity, using, environmental, feeding, enrichment, facilitate, weight, loss]
links:
  doi: "10.1111/j.1439-0396.2005.00611_1.x"
  url: "https://doi.org/10.1111/j.1439-0396.2005.00611_1.x"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of Animal Physiology and Animal Nutrition; year: 2005."
...
Abstract lead for scope check only: Obesity is regarded as the most common form of malnutrition seen by veterinarians. An estimated 25% of cats are described as overweight or obese and this condition is a known risk...

## One-Line Summary

Candidate obesity source from sheet row 177. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Using Environmental and Feeding Enrichment to Facilitate Feline Weight Loss.
- The intake sheet locator is: 10.1111/j.1439-0396.2005.00611_1.x.
