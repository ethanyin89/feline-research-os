...
tags: [obesity, effectiveness, body, mass, index, fbmi, new, diagnostic]
links:
  doi: ""
  url: "https://pubmed.ncbi.nlm.nih.gov/27348888/"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "The intake sheet lists this title: Effectiveness of feline body mass index (fBMI) as new diagnostic tool for obesity."
    - "The intake sheet locator is: https://pubmed.ncbi.nlm.nih.gov/27348888/."
...
Candidate obesity source from sheet row 149. Use it for triage until abstract or full-text extraction proves a stronger role.
