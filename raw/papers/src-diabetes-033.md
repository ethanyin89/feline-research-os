...
id: src-diabetes-033
type: source
title: "Glargine versus regular insulin protocol in feline diabetic ketoacidosis"
source_kind: paper
species: feline
...
tags: [diabetes, glargine, versus, regular, insulin, protocol, diabetic, ketoacidosis]
links:
...
evidence_policy:
  quoted_fact:
    ...
    - "Crossref container: Journal of Veterinary Emergency and Critical Care; year: 2021."
...
Abstract lead for scope check only: Abstract Objectives To determine whether basal‐bolus administration of glargine insulin is a safe and effective alternative treatment compared to the standard continuous rate infu...

## One-Line Summary

Candidate diabetes source from sheet row 45. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Glargine versus regular insulin protocol in feline diabetic ketoacidosis.
- The intake sheet locator is: 10.1111/vec.13062.
