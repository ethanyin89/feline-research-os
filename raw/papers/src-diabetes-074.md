...
id: src-diabetes-074
type: source
title: "Improving owner compliance with therapy of canine and feline diabetes: the American perspective"
source_kind: paper
species: feline
...
tags: [diabetes, improving, owner, compliance, therapy, american, perspective]
links:
  doi: "10.12968/coan.2023.0057"
  url: "https://doi.org/10.12968/coan.2023.0057"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Companion Animal; year: 2025."
...
Abstract lead for scope check only: Diabetes mellitus in dogs and cats presents unique challenges for pet owners, often resulting in treatment failure and decreased survival rates. However, there are strategies to e...

## One-Line Summary

Candidate diabetes source from sheet row 86. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Improving owner compliance with therapy of canine and feline diabetes: the American perspective.
- The intake sheet locator is: 10.12968/coan.2023.0057.
