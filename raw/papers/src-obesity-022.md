...
tags: [obesity, obesity-induced, changes, gene, expression, adipose, skeletal, muscle]
links:
  doi: "10.1111/jpn.13802"
  url: "https://doi.org/10.1111/jpn.13802"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of Animal Physiology and Animal Nutrition; year: 2023."
...
Abstract lead for scope check only: Abstract Indoor‐confined cats are prone to developing obesity due to a sedentary life and an energy intake exceeding energy requirements. As in humans, feline obesity decreases in...

## One-Line Summary

Candidate obesity source from sheet row 153. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Obesity-induced changes in gene expression in feline adipose and skeletal muscle tissue.
- The intake sheet locator is: 10.1111/jpn.13802.
