...
id: src-diabetes-108
type: source
title: "Investigation of serum IGF-I levels amongst diabetic and non-diabetic cats"
source_kind: paper
species: feline
...
tags: [diabetes, investigation, serum, igf-i, levels, amongst, diabetic, non-diabetic]
links:
  doi: "10.1016/j.jfms.2004.01.002"
  url: "https://doi.org/10.1016/j.jfms.2004.01.002"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of Feline Medicine and Surgery; year: 2004."
...
Abstract lead for scope check only: Since insulin-like growth factor-I (IGF-I) was first discovered as a mediator of glucose homeostasis, it has been extensively investigated in diabetes research in humans, rodents...

## One-Line Summary

Candidate diabetes source from sheet row 120. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Investigation of serum IGF-I levels amongst diabetic and non-diabetic cats.
- The intake sheet locator is: 10.1016/j.jfms.2004.01.002.
