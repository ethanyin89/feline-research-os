...
tags: [obesity, serum, lipid, amino, acid, acylcarnitine, profiles, obese]
links:
  doi: "10.3390/ani11082196"
  url: "https://doi.org/10.3390/ani11082196"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Animals; year: 2021."
...
Abstract lead for scope check only: Obesity is a health concern for domestic cats. Obesity and severe energy restriction predispose cats to feline hepatic lipidosis. As choline is linked to lipid metabolism, we hypo...

## One-Line Summary

Candidate obesity source from sheet row 197. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Serum Lipid, Amino Acid and Acylcarnitine Profiles of Obese Cats Supplemented with Dietary Choline and Fed to Maintenance Energy Requirements.
- The intake sheet locator is: 10.3390/ani11082196.
