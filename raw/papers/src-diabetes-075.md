...
tags: [diabetes, acromegaly, essential, differential, diagnosis, difficult, diabetic]
links:
  doi: "10.1016/j.jfms.2009.12.003"
  url: "https://doi.org/10.1016/j.jfms.2009.12.003"
  local_assets: []
evidence_policy:
  quoted_fact:
...
Abstract lead for scope check only: Practical relevance Clinicians who deal with diabetic cats can have mixed experiences. Some patients are ‘textbook cases’, responding very well to insulin administration; others p...

## One-Line Summary

Candidate diabetes source from sheet row 87. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Feline acromegaly: an essential differential diagnosis for the difficult diabetic.
- The intake sheet locator is: 10.1016/j.jfms.2009.12.003.
