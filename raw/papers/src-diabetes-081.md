...
tags: [diabetes, transient, clinical, cases]
links:
  doi: "10.1111/j.1939-1676.1999.tb02161.x"
  url: "https://doi.org/10.1111/j.1939-1676.1999.tb02161.x"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Journal of Veterinary Internal Medicine; year: 1999."
...
Abstract lead for scope check only: Abstarct Medical records of 10 cats with transient clinical diabetes mellitus were reviewed. At the time diabetes was diagnosed, clinical signs included polyuria and polydipsia (1...

## One-Line Summary

Candidate diabetes source from sheet row 93. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Transient clinical diabetes mellitus in cats: 10 cases (1989-1991).
- The intake sheet locator is: 10.1111/j.1939-1676.1999.tb02161.x.
