...
tags: [obesity, prevalence, risk, factors, urban, population, healthy]
links:
  doi: "10.1016/j.jfms.2008.07.002"
  url: "https://doi.org/10.1016/j.jfms.2008.07.002"
  local_assets: []
evidence_policy:
  quoted_fact:
...
Abstract lead for scope check only: The incidence of overweight in cats has been reported in various studies to range between 6 and 52% depending on such factors as gender, neutering, age, being cross-bred, living i...

## One-Line Summary

Candidate obesity source from sheet row 202. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Prevalence and risk factors of obesity in an urban population of healthy cats.
- The intake sheet locator is: 10.1016/j.jfms.2008.07.002.
