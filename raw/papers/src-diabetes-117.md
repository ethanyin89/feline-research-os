...
id: src-diabetes-117
type: source
title: "Exocrine Pancreas in Cats With Diabetes Mellitus"
source_kind: paper
species: feline
...
Abstract lead for scope check only: Pancreatitis has been described in cats with diabetes mellitus, although the number of studies currently available is very limited. In addition, ketoacidosis has been hypothesized...

## One-Line Summary

Candidate diabetes source from sheet row 129. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Exocrine Pancreas in Cats With Diabetes Mellitus.
- The intake sheet locator is: 10.1177/0300985815603434.
