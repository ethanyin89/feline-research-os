...
id: src-cancer-106
type: source
title: "Current status of canine cancer registration – report from an international workshop"
source_kind: paper
species: feline
diseases: [cancer]
models: []
...
tags: [cancer, current, status, registration, report, international, workshop]
links:
  doi: "10.1111/j.1476-5829.2011.00279.x"
  url: "https://doi.org/10.1111/j.1476-5829.2011.00279.x"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref resolves metadata and reports abstract availability for source scope checking."
    - "Resolved container: Veterinary and Comparative Oncology; year: 2012."
  ...
  # V2 enhanced fields
  study_design: "犬癌症登记国际研讨会报告（2011年Vet Comp Oncol），与猫无关"
  core_argument: "此来源不适用于猫癌症模块——标题明确说canine cancer registration，是犬类癌症流行病学/登记研讨会"
  implicit_premise: "N/A——误收录到猫癌症来源库"
  unexpected_finding: "N/A——误收录"
  title_gap: "标题明确说canine cancer registration，但被误收录到猫癌症来源——应移除或重新分类到犬类模块"
  evidence_boundary: "犬类研讨会报告（2011年），不适用于猫癌症模块；标记为误收录待清理"
---
...
Abstract lead for scope check only: This is a report from a workshop on canine cancer registration hosted at the Norwegian School of Veterinary Science in Oslo in August 2010. The aim is to present a summary of the...

## One-Line Summary

Candidate cancer source from sheet row 63. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Current status of canine cancer registration – report from an international workshop.
- The intake sheet locator is: 10.1111/j.1476-5829.2011.00279.x.
