...
tags: [obesity, impact, sex, diet, hepatic, glucose, production]
links:
  doi: "10.1152/ajpregu.90771.2008"
  url: "https://doi.org/10.1152/ajpregu.90771.2008"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: American Journal of Physiology-Regulatory, Integrative and Comparative Physiology; year: 2009."
...
Abstract lead for scope check only: Obesity is a risk factor for type 2 diabetes in cats. The risk of developing diabetes is severalfold greater for male cats than for females, even after having been neutered early...

## One-Line Summary

Candidate obesity source from sheet row 222. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: The impact of obesity, sex, and diet on hepatic glucose production in cats.
- The intake sheet locator is: 10.1152/ajpregu.90771.2008.
