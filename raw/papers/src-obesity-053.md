...
id: src-obesity-053
type: source
title: "Missense variants in MC4R gene are associated with obesity in cats"
source_kind: paper
species: feline
diseases: [obesity]
models: []
...
tags: [obesity, missense, variants, mc4r, gene, are, associated]
links:
  doi: "10.1007/s11259-025-10700-4"
  url: "https://doi.org/10.1007/s11259-025-10700-4"
  local_assets: []
evidence_policy:
  quoted_fact:
    - "Crossref metadata resolves this DOI and reports abstract availability for source scope checking."
    - "Crossref container: Veterinary Research Communications; year: 2025."
...
Abstract lead for scope check only: Abstract Obesity stands out as the most common multifactorial nutritional problem affecting domestic cats. According to studies, the prevalence of overweight or obese cats varies...

## One-Line Summary

Candidate obesity source from sheet row 191. Use it for triage until abstract or full-text extraction proves a stronger role.
...
- The intake sheet lists this title: Missense variants in MC4R gene are associated with obesity in cats.
- The intake sheet locator is: 10.1007/s11259-025-10700-4.
